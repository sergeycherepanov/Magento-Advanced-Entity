 ...
 */
class Ch_Entity_Block_Adminhtml_Entity_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    {
        parent::__construct();
        $this->setId('ch_entity_entity_tabs');
    ...
    protected function _prepareLayout()
    {
        $this->addTab('main_section', array(
            ...
            'content'   =>  $this->getLayout()->createBlock('ch_entity/adminhtml_entity_edit_tab_main')->toHtml(),
        ));
